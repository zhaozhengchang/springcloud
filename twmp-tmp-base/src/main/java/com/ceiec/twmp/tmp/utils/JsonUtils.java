...
/**
 * @Title: JsonUtil.java
 * @Package com.ceiec.gis.springboot.common.utils
...
public class JsonUtils {
	...
	public static String toDateFormatJSONString(Object object){
		return JSON.toJSONStringWithDateFormat(object, TIME_FORMAT,FEATURES);
	}
	...
	public static String toDateFormatJSONArrayString(Object object){
		return JSONArray.toJSONStringWithDateFormat(object, TIME_FORMAT, FEATURES);
	}
